...
export default [
  ...
  {
    start: startOfHour(addDays(2, new Date())),
    end: startOfHour(addHours(2, addDays(2, new Date()))),
    title: 'CM Feel Good',
    email: 'email@gmail.com',
    accepted: true,
    color: '#AFED23',
  ...
  {
    start: startOfHour(addHours(1, addDays(2, new Date()))),
    end: startOfHour(addHours(2, addDays(2, new Date()))),
    title: 'CM Java',
    email: 'email@gmail.com',
    accepted: true,
  ...
  {
    start: startOfHour(subHours(1, addDays(2, new Date()))),
    end: startOfHour(addHours(4, addDays(2, new Date()))),
    title: 'Test',
    email: 'email@gmail.com',
    accepted: true,
  },
